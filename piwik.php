...
if(isset($_GET['idsite']) && $_GET['idsite'] == 1){
    ...
    if(count($parts) == 8 && $parts[2] == "www.arrivalguides.com" && $parts[4] == "Travelguide" && isset($parts[5])){
       $SITE_NAME = $parts[5];
       if(isset($destination[strtoupper($SITE_NAME)])){
           $_GET['idsite'] = $destination[strtoupper($SITE_NAME)];
    ...
    if(count($parts) == 5 && $parts[2] == "cmwidget.arrivalguides.com" && $parts[3] == "widget" && isset($parts[4])){
       $arr = explode("&", $parts[4]);
       if(isset($arr[1])){
    ...
    if(count($parts) == 5 && $parts[2] == "widget.arrivalguides.com" && $parts[3] == "widget" && isset($parts[4])){
       $arr = explode("&", $parts[4]);
       if(isset($arr[1])){
          preg_match("/^iso=(.*)/i", $arr[1], $matches);
          $SITE_NAME = (isset($matches[1])) ? $matches[1] : "";
    ...
    if(count($parts) == 8 && $parts[2] == "www.arrivalguides.com" && $parts[4] == "Travelguides" && isset($parts[7])){
       $SITE_NAME = $parts[7];
       if(isset($destination[strtoupper($SITE_NAME)])){
           $_GET['idsite'] = $destination[strtoupper($SITE_NAME)];
       }else file_put_contents("front.log", strtoupper($SITE_NAME) . " not found\n", FILE_APPEND);
    ...
    if(count($parts) == 9 && $parts[2] == "www.arrivalguides.com" && $parts[4] == "Travelguides" && isset($parts[7])){
       $SITE_NAME = $parts[7];
       if(isset($destination[strtoupper($SITE_NAME)])){
           $_GET['idsite'] = $destination[strtoupper($SITE_NAME)];
       }else file_put_contents("front.log", strtoupper($SITE_NAME) . " not found\n", FILE_APPEND);
    ...
    if(count($parts) == 8 && $parts[2] == "www.arrivalguides.com" && $parts[4] == "Partner" && $parts[6] == "Destination" && isset($parts[7])){
       $arr = explode("&", $parts[7]);
file_put_contents("destinations.log", print_r($arr, true), FILE_APPEND);
    ...
    if(count($parts) == 6 && $parts[2] == "www.arrivalguides.com" && $parts[4] == "Destination" && isset($parts[5])){
       $arr = explode("&", $parts[5]);
       if(isset($arr[1])){
    ...
    if(count($parts) == 6 && $parts[2] == "www.arrivalguides.com" && $parts[4] == "Travelguide" && isset($parts[5])){
       $SITE_NAME = $parts[5];

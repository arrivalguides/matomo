 ...
 *
 */
namespace Piwik\Plugins\AgAnalytics\Widgets;
...
class FacebookWidget extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId(Piwik::translate('AgAnalytics_ArrivalGuidesAB'));
         ...
         */
        $config->setName('Facebook Widget');
...
//             );
         ...
         return '<div class="widgetBody">Facebook Widget Text</div>';
//             return $this->renderTemplate('facebook_widget', $report);
    }
